...
import { allowedByTrend, priorDayRange, roundToTick, sessionMinutes } from "@/core/strategies/shared/evaluator";
import { strategyRuntimeConfig } from "@/core/strategies/shared/runtime-config";

export function evaluateIctTurtleSoup(rule: StrategyRule, bars: EnrichedBar[], signalIndex: number) {
